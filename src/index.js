    ...
    const itineraryData = [
      {
        ...
        stops: [
          ...
          { name: "Dubai", latitude: 25.2048, longitude: 55.2708, order: 3, description: "Ultramodern city of superlatives in the Arabian Gulf" },
          { name: "Maldives", latitude: 3.2028, longitude: 73.2207, order: 4, description: "Paradise archipelago in the Indian Ocean" },
          { name: "Singapore", latitude: 1.3521, longitude: 103.8198, order: 5, description: "The Lion City — Asia's gleaming gateway" },
          { name: "Sydney", latitude: -33.8688, longitude: 151.2093, order: 6, description: "Australia's harbor city with its iconic Opera House" },
          { name: "Bora Bora", latitude: -16.5004, longitude: -151.7415, order: 7, description: "The jewel of the South Pacific" },
          { name: "Rio de Janeiro", latitude: -22.9068, longitude: -43.1729, order: 8, description: "Brazil's vibrant Marvelous City" },
          { name: "Reykjavik", latitude: 64.1466, longitude: -21.9426, order: 9, description: "Gateway to Iceland's dramatic landscapes" },
          { name: "New York", latitude: 40.7128, longitude: -74.006, order: 10, description: "The city that never sleeps" },
        ],
      },
      {
        ...
        stops: [
          ...
          { name: "Cape Town", latitude: -33.9249, longitude: 18.4241, order: 4, description: "South Africa's Mother City beneath Table Mountain" },
          { name: "Mumbai", latitude: 19.076, longitude: 72.8777, order: 5, description: "India's dynamic city of dreams" },
          { name: "Phuket", latitude: 7.8804, longitude: 98.3923, order: 6, description: "Thailand's largest island paradise" },
          { name: "Tokyo", latitude: 35.6762, longitude: 139.6503, order: 7, description: "Japan's electrifying capital of culture and innovation" },
          { name: "Honolulu", latitude: 21.3069, longitude: -157.8583, order: 8, description: "Hawaii's tropical capital on Oahu" },
          { name: "San Francisco", latitude: 37.7749, longitude: -122.4194, order: 9, description: "The City by the Bay" },
        ],
      },
      {
        ...
        stops: [
          ...
          { name: "Seychelles", latitude: -4.6796, longitude: 55.492, order: 3, description: "Pristine island paradise in the Indian Ocean" },
          { name: "Langkawi", latitude: 6.35, longitude: 99.8, order: 4, description: "Malaysia's jewel of Kedah" },
          { name: "Kyoto", latitude: 35.0116, longitude: 135.7681, order: 5, description: "Japan's cultural heart and ancient capital" },
          { name: "Fiji", latitude: -17.7134, longitude: 178.065, order: 6, description: "South Pacific island paradise" },
          { name: "Cartagena", latitude: 10.3910, longitude: -75.5364, order: 7, description: "Colombia's colorful Caribbean gem" },
          { name: "Lisbon", latitude: 38.7223, longitude: -9.1393, order: 8, description: "Portugal's sun-drenched capital of explorers" },
        ],
      },
      {
        ...
        stops: [
          ...
          { name: "Casablanca", latitude: 33.5731, longitude: -7.5898, order: 2, description: "Morocco's largest city and economic hub" },
          { name: "Zanzibar", latitude: -6.1659, longitude: 39.2026, order: 3, description: "The Spice Island off East Africa" },
          { name: "Colombo", latitude: 6.9271, longitude: 79.8612, order: 4, description: "Sri Lanka's vibrant capital" },
          { name: "Bali", latitude: -8.3405, longitude: 115.092, order: 5, description: "Indonesia's island of the gods" },
          { name: "Auckland", latitude: -36.8485, longitude: 174.7633, order: 6, description: "New Zealand's City of Sails" },
          { name: "Valparaíso", latitude: -33.0472, longitude: -71.6127, order: 7, description: "Chile's colorful Pacific port city" },
          { name: "Havana", latitude: 23.1136, longitude: -82.3666, order: 8, description: "Cuba's timeless and vibrant capital" },
          { name: "Copenhagen", latitude: 55.6761, longitude: 12.5683, order: 9, description: "Denmark's fairy tale capital" },
        ],
      },
      {
        ...
        stops: [
          ...
          { name: "Muscat", latitude: 23.588, longitude: 58.3829, order: 3, description: "Oman's elegant and historic capital" },
          { name: "Goa", latitude: 15.2993, longitude: 74.124, order: 4, description: "India's tropical beach paradise" },
          { name: "Hong Kong", latitude: 22.3193, longitude: 114.1694, order: 5, description: "Asia's World City at the edge of China" },
          { name: "Tahiti", latitude: -17.6509, longitude: -149.4260, order: 6, description: "French Polynesia's enchanting main island" },
          { name: "Buenos Aires", latitude: -34.6037, longitude: -58.3816, order: 7, description: "Argentina's passionate capital of tango" },
          { name: "Bermuda", latitude: 32.3078, longitude: -64.7505, order: 8, description: "Pink sand beaches in the Atlantic" },
        ],
      },
      {
        ...
        stops: [
          ...
          { name: "Ushuaia", latitude: -54.8019, longitude: -68.3030, order: 5, description: "The southernmost city — gateway to Antarctica" },
          { name: "Easter Island", latitude: -27.1127, longitude: -109.3497, order: 6, description: "Remote Polynesian island of the Moai statues" },
          { name: "Osaka", latitude: 34.6937, longitude: 135.5023, order: 7, description: "Japan's kitchen and cultural powerhouse" },
          { name: "Vladivostok", latitude: 43.1332, longitude: 131.9113, order: 8, description: "Russia's gateway to the Pacific" },
          { name: "Vancouver", latitude: 49.2827, longitude: -123.1207, order: 9, description: "Canada's Pacific jewel between mountains and sea" },
          { name: "Greenland", latitude: 64.1814, longitude: -51.6941, order: 10, description: "The world's largest island — Arctic wilderness" },
        ],
      },
    ];
