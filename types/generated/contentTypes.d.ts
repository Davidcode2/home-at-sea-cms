...
export interface ApiApartmentApartment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ship apartment/residence';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    monthlyFees: Schema.Attribute.Decimal;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    priceFrom: Schema.Attribute.Decimal;
    priceTo: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    ship: Schema.Attribute.Relation<'manyToOne', 'api::ship.ship'>;
    size: Schema.Attribute.Decimal;
    type: Schema.Attribute.Enumeration<
      ['studio', 'bed1', 'bed2', 'bed3', 'penthouse']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiItineraryStopItineraryStop
  extends Struct.CollectionTypeSchema {
  collectionName: 'itinerary_stops';
  info: {
    description: 'A stop on an itinerary';
    displayName: 'Itinerary Stop';
    pluralName: 'itinerary-stops';
    singularName: 'itinerary-stop';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiItineraryItinerary extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ship itinerary/route';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    ship: Schema.Attribute.Relation<'manyToOne', 'api::ship.ship'>;
    stops: Schema.Attribute.Relation<
      'oneToMany',
      'api::itinerary-stop.itinerary-stop'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearRound: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
  };
}
...
export interface ApiOperatorOperator extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ship operator/management company';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    ships: Schema.Attribute.Relation<'oneToMany', 'api::ship.ship'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiShipShip extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::ship.ship'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    operator: Schema.Attribute.Relation<'manyToOne', 'api::operator.operator'>;
    publishedAt: Schema.Attribute.DateTime;
    residenceCount: Schema.Attribute.Integer;
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog post/user story';
    displayName: 'Story';
    pluralName: 'stories';
    singularName: 'story';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::itinerary-stop.itinerary-stop': ApiItineraryStopItineraryStop;
